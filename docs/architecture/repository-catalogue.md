...
| **Testule** — canonical [`testule`](https://github.com/hackelia-micrantha/testule), public [`testule-community`](https://github.com/hackelia-micrantha/testule-community) | Library/tooling / testability contracts | Incubating | Canonical implementation owns Testule behavior; the public surface publishes specifications, compatibility/release policy, operator documentation, and distribution material | Replacing native test runners, CI/release authority, treating evidence as authorization, or implying public implementation source |
...
| **Entanglement of Ages** — authoritative creative source under `ryjen/entanglement-of-ages`; independently reviewed public marketing under `ryjen/entanglement-of-ages-marketing` | — / creative | Active | Canon, treatments, manuscript adaptation, publishing governance, and release preparation for the Entanglement of Ages creative project | Organization engineering standards, software project authority, or public disclosure of private creative-source material by implication |
...
| **MUSICPKG** — [`musicpkg`](https://github.com/hackelia-micrantha/musicpkg), [`musicpkg-community`](https://github.com/hackelia-micrantha/musicpkg-community) | Laboratory / digital ownership protocol + platform | Experimental | Private repository owns engineering implementation, unpublished security research, adversarial testing, and publication staging; public community repository owns published wire-format, verification, schemas, test vectors, and conformance contracts | Subscription/rental DRM, publisher-controlled playback leases, absolute prevention of privileged PCM/analog capture, or legal determination of resale rights |
...
| **Myosotis** — [`myosotis`](https://github.com/hackelia-micrantha/myosotis), [`myosotis-community`](https://github.com/hackelia-micrantha/myosotis-community) | Laboratory / governed field-tool platform | Experimental | Protocols and SDK architecture for governed field-operated AI tools with device-local policy, consent, provenance, and deterministic failure behavior | Dubnium orchestration, Amaryllis inference behavior, or ambient agent execution authority |
